...
public class IoTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IoTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getComparisonConditionAccess().getOperatorAlternatives_1_1_0(), "rule__ComparisonCondition__OperatorAlternatives_1_1_0");
			builder.put(grammarAccess.getPrimaryConditionAccess().getAlternatives(), "rule__PrimaryCondition__Alternatives");
			builder.put(grammarAccess.getLiteralBooleanAccess().getAlternatives(), "rule__LiteralBoolean__Alternatives");
			...
			builder.put(grammarAccess.getFetchDataAccess().getGroup_9(), "rule__FetchData__Group_9__0");
			builder.put(grammarAccess.getFetchDataAccess().getGroup_10(), "rule__FetchData__Group_10__0");
			...
			builder.put(grammarAccess.getFetchDataConditionAccess().getGroup_1(), "rule__FetchDataCondition__Group_1__0");
			builder.put(grammarAccess.getFetchDataConditionAccess().getGroup_2(), "rule__FetchDataCondition__Group_2__0");
			...
			builder.put(grammarAccess.getComparisonConditionAccess().getGroup_1(), "rule__ComparisonCondition__Group_1__0");
			builder.put(grammarAccess.getPrimaryConditionAccess().getGroup_0(), "rule__PrimaryCondition__Group_0__0");
			builder.put(grammarAccess.getLiteralBooleanAccess().getGroup_0(), "rule__LiteralBoolean__Group_0__0");
			builder.put(grammarAccess.getLiteralBooleanAccess().getGroup_1(), "rule__LiteralBoolean__Group_1__0");
			builder.put(grammarAccess.getLiteralIntegerAccess().getGroup(), "rule__LiteralInteger__Group__0");
			...
			builder.put(grammarAccess.getFetchDataAccess().getConditionAssignment_9_1(), "rule__FetchData__ConditionAssignment_9_1");
			builder.put(grammarAccess.getFetchDataAccess().getTriggeredAssignment_10_1(), "rule__FetchData__TriggeredAssignment_10_1");
			...
			builder.put(grammarAccess.getFetchDataConditionAccess().getConditionAssignment_1_1(), "rule__FetchDataCondition__ConditionAssignment_1_1");
			builder.put(grammarAccess.getFetchDataConditionAccess().getElseAssignment_2_1(), "rule__FetchDataCondition__ElseAssignment_2_1");
			...
			builder.put(grammarAccess.getComparisonConditionAccess().getOperatorAssignment_1_1(), "rule__ComparisonCondition__OperatorAssignment_1_1");
			builder.put(grammarAccess.getComparisonConditionAccess().getRightAssignment_1_2(), "rule__ComparisonCondition__RightAssignment_1_2");
			builder.put(grammarAccess.getLiteralBooleanAccess().getValueAssignment_0_1(), "rule__LiteralBoolean__ValueAssignment_0_1");
			builder.put(grammarAccess.getLiteralBooleanAccess().getValueAssignment_1_1(), "rule__LiteralBoolean__ValueAssignment_1_1");
			builder.put(grammarAccess.getLiteralIntegerAccess().getValueAssignment_1(), "rule__LiteralInteger__ValueAssignment_1");
